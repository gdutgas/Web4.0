...
MySQL - 5.5.20 : Database - question bank
*********************************************************************
2015-10-22 更新  Felix  
用户	info@localhost----info
*/
...
insert  into `tb_admin`(`admin_id`,`admin_name`,`password`,`email`,`phone`) values (1,'admin','admin',NULL,NULL),(2,'aaa','123',NULL,NULL);
...
CREATE TABLE `tb_question` (/*type 改成了varchar型，接收中文信息  XP-2015-10-24 */
...
insert  into `tb_user`(`user_id`,`user_name`,`password`,`phone`,`email`) values (1,'user','ouyang','18826400674','oyrongtai@163.com'),(2,'abc','123',NULL,NULL);
